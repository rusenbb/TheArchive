...
def launch_setup(context, *args, **kwargs):
    ...
    #Argumments
    worldFileName = LaunchConfiguration('world', default='A1_world.world')
    use_sim_time = LaunchConfiguration('use_sim_time', default='True')
    x_pose = LaunchConfiguration('x_pose', default='-3')
    y_pose = LaunchConfiguration('y_pose', default='-3')
    world_file_name_str = worldFileName.perform(context)
    #Packages
    pkg_share_dir = get_package_share_directory('a1')
    pkg_prefix_dir = get_package_prefix('a1')
