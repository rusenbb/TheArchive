...
class RobotController(Node):
    def __init__(self):
        ...
        #   2 consecutive frames no person or 15 seconds, whichever first
        #
    ...
    def control_loop(self):
        ...
        if self.action_state == "PATROLLING":
            ...
            # (flag set in box_detected_callback)
            ...
            # If we've just detected that we should do the 90° CCW turn sequence
                ...
                self.consecutive_no_person_frames = 0
                # Skip normal patrol movement this cycle
            else:
            ...
            # Condition 1: 2 consecutive frames no person
        ...
        # Reset the detection flags each cycle 
        self.person_box_detected_this_frame = False
    ...
    def box_detected_callback(self, msg):
        ...
        # If we see area>100000, offset NOT in [-300,300], and we are in PATROLLING => trigger crosswalk stop
        # We'll just set crosswalk_stop_start_time if we haven't already, and if we are in PATROLLING.
        ...
        # Only if we are in PATROLLING (so we don't keep tracking once in other states).
        if self.action_state == "PATROLLING" and largest_in_range_area > 0:
            ...
            if self.consecutive_area_increases >= 2:
                ...
                # so it doesn't keep triggering repeatedly.
                self.consecutive_area_increases = 0
        else:
